    ...
    return (
        <div className="fixed bottom-4 right-4 bg-gradient-to-br from-[#1a1a2e] to-black text-white rounded-lg shadow-lg z-50 w-80 h-96 flex flex-col">
            <div className="p-3 border-b border-gray-700 flex justify-between items-center">
                <h3 className="font-semibold text-sm">Cilio Assistant <FaRobot className="inline text-white text-lg ml-2" /></h3>
...
const ChatBotToggle = () => {
    ...
    return (
        <div>
            ...
            >
                <TbMessageChatbotFilled className="text-3xl text-blue-300" />
            </button>
